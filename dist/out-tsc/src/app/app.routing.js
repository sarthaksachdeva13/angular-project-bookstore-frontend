...
var appRoutes = [
    ...
    { path: 'bookDetail/:id', component: book_detail_component_1.BookDetailComponent },
    { path: 'shoppingCart', component: shopping_cart_component_1.ShoppingCartComponent },
    { path: 'checkout', component: order_component_1.OrderComponent },
    { path: 'orderSummary', component: order_summary_component_1.OrderSummaryComponent },
    { path: 'search/:searchQ', component: book_list_api_component_1.BookListAPIComponent },
    { path: 'book/:bookId', component: book_description_api_component_1.BookDescriptionApiComponent }
];
